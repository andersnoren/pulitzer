...
<div class="wp-block-group" style="margin-top:var(--wp--preset--spacing--80);margin-bottom:var(--wp--preset--spacing--80)">
	...
	<div class="wp-block-group">
		...
		<h2 class="wp-block-heading has-small-font-size"><?php esc_html_e( 'Work Experience', 'pulitzer' ); ?></h2>
		<!-- /wp:heading -->
		...
		<div class="wp-block-columns">
			...
			<div class="wp-block-column has-contrast-2-color has-text-color has-link-color has-system-sans-serif-font-family has-small-font-size"
				...
				<p><?php esc_html_e( '1885 – 1886', 'pulitzer' ); ?></p>
				<!-- /wp:paragraph -->
			</div>
			<!-- /wp:column -->
			...
			<div class="wp-block-column">
				...
				<div class="wp-block-group has-system-sans-serif-font-family has-small-font-size">
					...
					<p style="font-style:normal;font-weight:500"><?php esc_html_e( 'U.S. House of Representatives', 'pulitzer' ); ?></p>
					<!-- /wp:paragraph -->

					<!-- wp:paragraph {"style":{"elements":{"link":{"color":{"text":"var:preset|color|contrast-2"}}}},"textColor":"contrast-2"} -->
					<p class="has-contrast-2-color has-text-color has-link-color"><?php esc_html_e( 'New York’s 9th district', 'pulitzer' ); ?></p>
					<!-- /wp:paragraph -->
				</div>
				<!-- /wp:group -->

				<!-- wp:paragraph -->
				<p><?php esc_html_e( 'I led the crusade to place the newly gifted Statue of Liberty in New York City, and served as a member of the Committee on Commerce.', 'pulitzer' ); ?></p>
				<!-- /wp:paragraph -->
			</div>
			<!-- /wp:column -->
		</div>
		...
		<div class="wp-block-columns">
			...
			<div class="wp-block-column has-contrast-2-color has-text-color has-link-color has-system-sans-serif-font-family has-small-font-size"
				style="font-style:normal;font-weight:500;flex-basis:30%"><!-- wp:paragraph -->
				<p><?php esc_html_e( '1883 – 1911', 'pulitzer' ); ?></p>
				<!-- /wp:paragraph -->
			</div>
			<!-- /wp:column -->
			...
			<div class="wp-block-column">
				...
				<div class="wp-block-group has-system-sans-serif-font-family has-small-font-size">
					<!-- wp:paragraph {"style":{"typography":{"fontStyle":"normal","fontWeight":"500"}}} -->
					<p style="font-style:normal;font-weight:500"><?php esc_html_e( 'New York World', 'pulitzer' ); ?></p>
					<!-- /wp:paragraph -->

					<!-- wp:paragraph {"style":{"elements":{"link":{"color":{"text":"var:preset|color|contrast-2"}}}},"textColor":"contrast-2"} -->
					<p class="has-contrast-2-color has-text-color has-link-color"><?php esc_html_e( 'Publisher and owner', 'pulitzer' ); ?></p>
					<!-- /wp:paragraph -->
				</div>
				<!-- /wp:group -->

				<!-- wp:paragraph -->
				<p><?php esc_html_e( 'I doubled the circulation of the New York World within three months of acquiring the paper.', 'pulitzer' ); ?></p>
				<!-- /wp:paragraph -->
			</div>
			<!-- /wp:column -->
		</div>
		...
		<div class="wp-block-columns">
			...
			<div class="wp-block-column has-contrast-2-color has-text-color has-link-color has-system-sans-serif-font-family has-small-font-size"
				style="font-style:normal;font-weight:500;flex-basis:30%"><!-- wp:paragraph -->
				<p><?php esc_html_e( '1878 – 1911', 'pulitzer' ); ?></p>
				<!-- /wp:paragraph -->
			</div>
			<!-- /wp:column -->
			...
			<div class="wp-block-column">
				...
				<div class="wp-block-group has-system-sans-serif-font-family has-small-font-size">
					<!-- wp:paragraph {"style":{"typography":{"fontStyle":"normal","fontWeight":"500"}}} -->
					<p style="font-style:normal;font-weight:500"><?php esc_html_e( 'St. Louis Post-Dispatch', 'pulitzer' ); ?></p>
					<!-- /wp:paragraph -->
				...
				<!-- wp:paragraph -->
				<p><?php esc_html_e( 'During my short time in Jefferson City, I voted for the adoption of the Fifteenth Amendment and led a crusade to reform the corrupt count court.', 'pulitzer' ); ?></p>
				<!-- /wp:paragraph -->
			</div>
			<!-- /wp:column -->
		</div>
